namespace LazyLoading
{
    internal class Program
    {
        ...
        {
            LazyRecordStore recordStore = new LazyRecordStore(); // Vinyls gets loaded in here, as they get called in constructor
            ...
            foreach (Vinyl vinyls in recordStore.Vinyls)
            {
